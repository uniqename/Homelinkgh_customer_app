class ServiceTypes {
  ...
  static const List<Map<String, dynamic>> generalFrameworkFields = [
    ...
    {'name': 'budgetRange', 'label': 'What\'s your budget range? (GH₵)', 'type': 'dropdown', 'options': ['Under ₵200', '₵200-500', '₵500-1,000', '₵1,000-2,000', '₵2,000-5,000', '₵5,000+', 'Open to quotes'], 'required': false, 'category': 'general'},
