...
class AdminCommissionManagementScreen extends StatefulWidget {
  ...
  @override
  State<AdminCommissionManagementScreen> createState() =>
      _AdminCommissionManagementScreenState();
}

class _AdminCommissionManagementScreenState
    extends State<AdminCommissionManagementScreen> {
  ...
  Widget build(BuildContext context) {
    return AdminAuthGuard(
      screenName: 'Commission Management',
      child: Scaffold(
        appBar: AppBar(
  ...
  String _getServiceCategory(String service) {
    if (['House Cleaning', 'Laundry Service'].contains(service))
      return 'Cleaning';
    if ([
      'Plumbing',
      'Electrical Services',
  ...
  void _saveChanges() {
    ...
    for (final entry in _commissionRates.entries) {
      ...
      if (rate < 0 || rate > 50) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Invalid rate for ${entry.key}: Must be between 0% and 50%',
            ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Are you sure you want to save these commission rate changes? This will affect all future bookings.',
        ),
        actions: [
          TextButton(
  ...
  void _resetToDefaults() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'This will reset all commission rates to their default values. Are you sure?',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
