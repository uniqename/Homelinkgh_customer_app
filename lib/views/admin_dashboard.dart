...
import 'admin_staff_payroll_screen.dart';
...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Widget build(BuildContext context) {
    // Authentication guard - check if user is admin
    final authService = AuthService();
    final currentUser = authService.currentUser;

    // If no user or not admin, show access denied screen
    if (currentUser == null) {
      return Scaffold(
        appBar: AppBar(
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  subtitle: const Text('Manage employee paychecks and compensation'),
                  trailing: const Icon(Icons.arrow_forward_ios),
                  onTap: _manageStaffPayroll,
                ),
              ],
            ),
          ),
  ...
  void _manageStaffPayroll() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const AdminStaffPayrollScreen(),
      ),
    );
  }
