...
class _AdminMonitoringScreenState extends State<AdminMonitoringScreen>
  ...
  void _loadMockData() {
    ...
    // This method is called on initialization and refresh
    _activeOrders = [
      ServiceRequest(
        id: '001',
        customerId: 'cust_001',
  ...
  void _refreshData() {
    ...
    setState(() {
      ...
      _serviceStats['Food Delivery'] =
          (_serviceStats['Food Delivery'] ?? 0) + 1;
    });
  }
    ...
    return Card(
      ...
      child: ListTile(
        leading: Container(
          ...
          child: Icon(_getServiceIcon(order.serviceType), color: statusColor),
        ),
        title: Text(
          order.description,
