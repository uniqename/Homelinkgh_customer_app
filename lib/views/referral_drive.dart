...
class _ReferralDriveScreenState extends State<ReferralDriveScreen> {
  ...
  Future<void> _loadReferralData() async {
    ...
    try {
      ...
      final code = await _referralService.generateReferralCode(user.id);
  ...
  int _getUserRank() {
    // Return user's actual leaderboard rank from backend
    return userRank > 0 ? userRank : 999;
  }
  ...
  void _shareToWhatsApp() async {
    ...
    await Share.share(message, subject: 'Join HomeLinkGH');
  }

  void _shareToFacebook() async {
    final message = "🇬🇭 Join me on HomeLinkGH! Use code $userReferralCode for ₵20 credit. https://homelink.gh/app";
    await Share.share(message, subject: 'Join HomeLinkGH');
  }

  void _shareToTwitter() async {
    final message = "🇬🇭 Excited to be part of @HomeLinkGH soft launch! Connecting Ghana's diaspora with trusted home services. Use code $userReferralCode for ₵20 credit! #GhanaDiaspora #HomeLinkGH https://homelink.gh/app";
