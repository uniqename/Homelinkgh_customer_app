...
class _AdminPendingApprovalsScreenState
  ...
  final List<Map<String, dynamic>> _pendingApprovals = [
    {
      ...
      'experience': '5 years',
      'description':
          'Professional electrician with 5 years of experience in residential and commercial electrical work.',
    },
    {
      'id': '2',
      'type': 'Provider Application',
      ...
      'experience': '3 years',
      'description':
          'Certified makeup artist and hair stylist specializing in bridal makeup and special events.',
    },
    {
      'id': '3',
    ...
    },
    {
      ...
      'experience': '2 years',
      'description':
          'Professional cleaning service with focus on residential and office cleaning.',
    },
  ];
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              spacing: 8,
              runSpacing: 8,
              children: (approval['documents'] as List<String>)
                  .map(
                    (doc) => GestureDetector(
  ...
  void _approveApplication(Map<String, dynamic> approval, int index) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to approve ${approval['name']}\'s application?',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
  ...
  Map<String, dynamic> _generateDocumentData(
    ...
    switch (documentType.toLowerCase()) {
      ...
      case 'id card':
        return {
          ...
          'idNumber':
              'GHA-${DateTime.now().millisecondsSinceEpoch.toString().substring(5)}',
          'dateOfBirth': '15/03/1990',
          'issueDate': '10/01/2020',
          'expiryDate': '10/01/2030',
          'district': approval['location'].split(',').first,
          'imageUrl':
              null, // In real app, this would be the actual document image
        };
      case 'business license':
        return {
          'businessName': approval['businessName'] ?? 'Sample Business',
          'licenseNumber':
              'BL-2024-${DateTime.now().millisecondsSinceEpoch.toString().substring(8)}',
      ...
      case 'training certificate':
        return {
          ...
          'certificateId':
              'CERT-2023-${DateTime.now().millisecondsSinceEpoch.toString().substring(6)}',
          'grade': 'Grade A',
          'imageUrl': null,
        };
      case 'utility bill':
        return {
          ...
          'provider': 'ECG Ghana',
          'accountNumber':
              'ECG-${DateTime.now().millisecondsSinceEpoch.toString().substring(7)}',
          'imageUrl': null,
        };
      default:
        return {
