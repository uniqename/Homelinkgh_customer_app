...
class _AdminServiceAreasScreenState extends State<AdminServiceAreasScreen> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ...((area['regions'] as List<Map<String, dynamic>>)
                .map((region) => _buildRegionTile(region, area, index))
                .toList()),
  ...
  void _editSubRegion(
    ...
    final radiusController = TextEditingController(
      text: region['serviceRadius'].toString(),
    );
            ...
            onPressed: () {
              if (nameController.text.trim().isNotEmpty) {
                setState(() {
                  ...
                  region['serviceRadius'] =
                      int.tryParse(radiusController.text) ?? 15;
                });
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
