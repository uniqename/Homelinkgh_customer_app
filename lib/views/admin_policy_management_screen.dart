...
class AdminPolicyManagementScreen extends StatefulWidget {
  ...
  @override
  State<AdminPolicyManagementScreen> createState() =>
      _AdminPolicyManagementScreenState();
}

class _AdminPolicyManagementScreenState
    extends State<AdminPolicyManagementScreen> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text(policy['content'], style: const TextStyle(fontSize: 14)),
              ],
            ),
          ),
        ),
  ...
  void _publishPolicy(Map<String, dynamic> policy, int index) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to publish "${policy['title']}"? This will make it active for all users.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
          ...
          ElevatedButton(
            onPressed: () {
              setState(() {
                ...
                _policies[index]['lastUpdated'] = DateTime.now()
                    .toString()
                    .substring(0, 10);
              });
              Navigator.pop(context);
  ...
  void _archivePolicy(Map<String, dynamic> policy, int index) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to archive "${policy['title']}"? Users will no longer see this policy.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
