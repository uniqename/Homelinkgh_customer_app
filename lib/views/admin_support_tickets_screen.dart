  ...
  final List<Map<String, dynamic>> _supportTickets = [
    {
      ...
      'description':
          'My payment was deducted but the booking is not confirmed. Need urgent help.',
      'user': 'Akosua Mensah',
      'userType': 'Customer',
    ...
    },
    {
      ...
      'description':
          'The cleaner was supposed to come at 2 PM but never showed up. I need a refund or reschedule.',
      'user': 'Michael Asante',
      'userType': 'Customer',
    ...
    },
    {
      ...
      'description':
          'Getting error message when trying to update my business profile. Cannot change service areas.',
      'user': 'Kwame Asante',
      'userType': 'Provider',
    ...
    },
    {
      ...
      'description':
          'The app keeps crashing when I try to accept a job. iPhone 14 Pro, iOS 17.5.',
      'user': 'Grace Owusu',
      'userType': 'Provider',
      'category': 'Technical Issue',
      'priority': 'Medium',
    ...
    },
    {
      ...
      'description':
          'My Ghana Card was rejected during verification. The image is clear and valid. Please review.',
      'user': 'Joseph Nkrumah',
      'userType': 'Customer',
