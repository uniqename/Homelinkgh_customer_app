...
class _AdminPaycheckScreenState extends State<AdminPaycheckScreen>
        ...
        body: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [Color(0xFF006B3C), Colors.white],
              stops: [0.0, 0.3],
            ),
          ),
          child: Column(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                NumberFormat(
                                  '#,###',
                                ).format(currentPaycheck['netProfit']),
                                style: const TextStyle(
                                  fontSize: 36,
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xFF006B3C),
            ...
            child: Column(
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const Text('Gross Revenue', style: TextStyle(fontSize: 16)),
                    Text(
                      '₵${NumberFormat('#,###').format(currentPaycheck['grossRevenue'])}',
                      style: const TextStyle(
                        fontSize: 16,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _buildKPICard('Revenue Growth', '+23.5%', Colors.green),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _buildKPICard('Profit Margin', '68.9%', Colors.blue),
              ),
            ],
          ),
          const SizedBox(height: 12),
          Row(
            children: [
              ...
              const SizedBox(width: 12),
              Expanded(
                child: _buildKPICard('Booking Success', '97.8%', Colors.purple),
              ),
            ],
          ),
  ...
  Widget _buildOperationalCostItem(
    String category,
    double amount,
    double percentage,
  ) {
  ...
  Widget _buildServiceCategoryItem(
    String category,
    int bookings,
    double revenue,
  ) {
