...
class _StreamlinedBookingFlowState extends State<StreamlinedBookingFlow> {
  ...
  void _loadMockQuotes() {
    // Quotes will be loaded from Firebase when providers respond to service request
    // Providers submit quotes after reviewing the service request details
    setState(() {
      _receivedQuotes = []; // Real quotes loaded from Firebase
    });
  }
}