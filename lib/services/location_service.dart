...
class LocationService {
  ...
  static Future<Map<String, dynamic>> getCurrentLocationContext() async {
    ...
    return {
      'region': locationService.currentCountry ?? 'Unknown',
      'state': locationService.currentState ?? 'Unknown',
      'city': locationService.currentCity ?? 'Unknown',
      'position': position,
      'isInGhana': locationService.isInGhana,
      'isInUSA': locationService.isInUSA,
    };
  }
}